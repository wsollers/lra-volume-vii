...
Canonical overlay: capabilities/overlays/lra-volume-vii.md
...
Repository: `lra-volume-vii`
Canonical repo overlay: `capabilities/overlays/lra-volume-vii.md`
Canonical route resolver:
`python <governance-root>/scripts/govpy.py capabilities/resolve.py --repo lra-volume-vii --task "<user task>" --root <repo-root>`
