...
\begin{propositionbox}{Definition (Box / Product Interval)}
\label{def:box}
...
\begin{propositionbox}{Definition (Box Containment)}
...
\begin{propositionbox}{Definition (Minkowski Addition of Boxes)}
\label{def:box-add}
...
\begin{propositionbox}{Definition (Box Subtraction / Difference)}
\label{def:box-sub}
...
\begin{propositionbox}{Definition (Scalar Multiplication of a Box)}
\label{def:box-smul}
...
\begin{propositionbox}{Definition (Coordinatewise / Hadamard Product of Boxes)}
