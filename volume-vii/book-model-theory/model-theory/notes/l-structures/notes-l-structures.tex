...
% --------------------------------------------------------------
%  \S{}1  FIRST-ORDER LANGUAGES
% --------------------------------------------------------------

\subsection*{First-Order Languages}

\begin{definitionbox}{Definition (First-Order Language $\mathcal{L}$)}
\begin{definition}[First-Order Language $\mathcal{L}$]\label{def:first-order-language}
...
An \textbf{$\mathcal{L}$-structure} $\mathcal{M}$ is an interpretation of the
symbols of $\mathcal{L}$ on a non-empty domain.
\end{definition}
\end{definitionbox}
...
\[
\mathsf{Structure}(\mathcal{M},\mathcal{L})
\coloneqq
M \neq \emptyset
\land
\forall f \in \mathcal{F}_{(n)}\, (f^{\mathcal{M}} : M^n \to M)
\land
\forall R \in \mathcal{R}_{(n)}\, (R^{\mathcal{M}} \subseteq M^n)
\land
\forall c \in \mathcal{C}\, (c^{\mathcal{M}} \in M).
\]
\end{remark*}
...
\begin{itemize}
  ...
  \item \hyperref[def:variable]{Variable}
  \item \hyperref[def:function]{Function}
  \item \hyperref[def:countable]{Countable}
\end{itemize}
\end{dependencies}
...
\begin{definition}[Term Evaluation]\label{def:term-evaluation}
...
\begin{itemize}
  \item \hyperref[def:l-structure]{$\mathcal{L}$-Structure}
  \item \hyperref[def:variable-assignment]{Variable Assignment}
...
% --------------------------------------------------------------
%  \S{}5  SATISFACTION  [STUB]
% --------------------------------------------------------------

\subsubsection*{Satisfaction \textnormal{[Stub]}}
...
% --------------------------------------------------------------
%  \S{}6  ELEMENTARY EQUIVALENCE AND SUBSTRUCTURES  [STUB]
% --------------------------------------------------------------

\subsubsection*{Elementary Equivalence and Substructures \textnormal{[Stub]}}
